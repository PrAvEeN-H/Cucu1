@CancelBooking
Feature: Verifying OMRBranch Cancel Booking Automation

  Scenario Outline: Cancel booking of generated order id
  ...
  Scenario Outline: Cancel booking of existing order id
    Given User is on OMRBranch hotel page
    When User enter "<userName>" and "<password>"
    Then User should verify success message after login "Welcome Akash"
    ...
    Examples: 
      | userName             | password  | exeOrderId |
      | akashka888@gmail.com | Akash@123 | RKXVT92130 |

  Scenario Outline: Cancel the first available  order id
    Given User is on OMRBranch hotel page
    When User enter "<userName>" and "<password>"
    Then User should verify success message after login "Welcome Akash"
    When User navigates to my booking page after login
  ...
  Scenario Outline: Cancel generated order id after changing the booking
    Given User is on OMRBranch hotel page
    When User enter "<userName>" and "<password>"
    Then User should verify success message after login "Welcome Akash"
    When User search hotels "<stateName>","<cityName>","<roomType>","<checkInDate>","<checkOutDate>","<noOfRoom>","<noOfAdult>" and "<noOfChild>"
